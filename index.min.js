!(function(e, t) {
  ...
  function y(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
      ...
      s = m(e),
      o = v(s, a),
      l = g(s, { firstDayOfWeek: a, firstWeekContainsDate: i }),
  ...
  function W(e, t) {
    ...
    try {
      ...
      if (
        ...
        var v = g(void 0 === l ? s : new Date(l, 3), {
      ...
      var y = E.apply(
        ...
        C = 60 * (void 0 === h ? y.getTimezoneOffset() : h) * 1e3,
        w = new Date(y.getTime() + C);
  ...
  j('Y', F, 'year'),
    ...
    j('MMM', H('monthsShort'), L('monthsShort', 'month')),
    j('MMMM', H('months'), L('months', 'month')),
    j('D', A, 'day'),
    j('DD', $, 'day'),
    j(['H', 'h'], A, 'hour'),
    j(['HH', 'hh'], $, 'hour'),
    ...
    j('d', P, 'weekday'),
    j('dd', H('weekdaysMin'), L('weekdaysMin', 'weekday')),
    j('ddd', H('weekdaysShort'), L('weekdaysShort', 'weekday')),
    j('dddd', H('weekdays'), L('weekdays', 'weekday')),
    j('w', A, 'week'),
    j('ww', $, 'week');
  var ee,
    te = (function(e, t) {
    ...
    ne =
      (ee = te) && ee.__esModule && Object.prototype.hasOwnProperty.call(ee, 'default')
        ? ee.default
        : ee,
    ae = 'en',
    re = {};
      ...
      void 0,
      {
        ...
        mounted: function() {
          ...
          (this._displayPopup =
            ...
            (this._scrollParent = oe(a) || window),
        ...
        computed: {
          ...
          yearMonth: function() {
            var e = this.getLocale(),
              ...
              s =
                'th' === e.name
                  ? { panel: 'year', label: this.calendar.getFullYear() + 543 }
                  : { panel: 'year', label: this.formatDate(this.calendar, n) },
              o = { panel: 'month', label: this.formatDate(this.calendar, i) };
            return a ? [o, s] : [s, o];
          },
          days: function() {
            var e = this.getLocale(),
      ...
      void 0,
      {
        ...
        computed: {
          calendarYear: function() {
            var e = this.getLocale();
            return this.calendar.getFullYear() + ('th' === e.name ? 543 : 0);
          },
          months: function() {
            var e = this.getLocale(),
    ...
    ve = le(
      ...
      void 0,
      {
        ...
        methods: {
          getYears: function(e) {
            for (
              var t = this.getLocale(), n = 10 * Math.floor(e.getFullYear() / 10), a = [], r = 0;
              r < 10;
              r++
            )
              a.push(n + r + ('th' === t.name ? 543 : 0));
            return K(a, 2);
          },
          getNextCalendar: function(e) {
            return R(this.calendar.getFullYear() + e, this.calendar.getMonth());
          ...
          handleClick: function(e) {
            var t = this.getLocale(),
              n = e.target;
            'DIV' === n.tagName.toUpperCase() && (n = n.parentNode);
            var a = n.getAttribute('data-year');
            a && this.$emit('select', parseInt(a - ('th' === t.name ? 543 : 0), 10));
          },
        },
      },
      void 0,
      ...
      methods: {
        ...
        handleSelectYear: function(e) {
          if ('year' === this.type) {
            ...
            (this.handleCalendarChange(R(e, this.calendarMonth), 'year'),
        ...
        handleSelectMonth: function(e) {
          if ('month' === this.type) {
            ...
            (this.handleCalendarChange(R(this.calendarYear, e), 'month'),
        ...
        created: function() {
          (this.scrollbarWidth = (function() {
            ...
            return (
              (t.style.width = '100%'),
              e.appendChild(t),
              (ue = e.offsetWidth - t.offsetWidth),
  ...
  var xe = le(
    ...
    Te = le(
      ...
      {
        name: 'TimePanel',
        components: { ListColumns: Se, ListOptions: xe },
        inject: {
          getLocale: {
            default: function() {
              return se;
    ...
    Ve = {
      ...
      props: r({}, ge.props, {}, Te.props, { showTimePanel: { type: Boolean, default: void 0 } }),
      data: function() {
      ...
      methods: {
        ...
        handleSelect: function(e, t) {
          ...
          ((n = q(e, this.defaultValue)), this.disabledTime(new Date(n)))
            ? (this.currentValue = n)
            : this.emitDate(n, t);
        },
      },
      render: function() {
        ...
        return e('div', [
          e(ge, f([{}, t])),
          this.timeVisible && e(Te, f([{ class: ''.concat(a, '-calendar-time') }, n])),
        ]);
      },
    },
    Oe = {
      ...
      inject: { prefixClass: { default: 'mx' } },
      emits: ['select', 'update:show-time-panel'],
      props: r({}, ye.props, {}, Me.props, { showTimePanel: { type: Boolean, default: void 0 } }),
      data: function() {
        return { defaultTimeVisible: !1, currentValue: this.value };
      },
      computed: {
      ...
      render: function() {
        ...
        return e('div', [
          e(ye, f([{}, t])),
          this.timeVisible && e(Me, f([{ class: ''.concat(a, '-calendar-time') }, n])),
        ]);
      },
    },
    _e = { default: ge, time: Te, datetime: Ve },
    Ye = { default: ye, time: Me, datetime: Oe },
    Pe = {
      name: 'DatePicker',
      provide: function() {
        var e = this;
            ...
            [
              ...
              this.showClearIcon
                ? e(
                    ...
                    [this.renderSlot('icon-clear', e(he))]
                  )
                : null,
  ...
  return (
    ...
    'undefined' != typeof window && window.Vue && Pe.install(window.Vue),
    n(Pe, {
      CalendarPanel: ge,
      CalendarRange: ye,
      TimePanel: Te,
