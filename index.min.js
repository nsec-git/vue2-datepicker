!(function(e, t) {
  ...
  j('Y', F, 'year'),
    ...
    j('MMM', H('monthsShort'), E('monthsShort', 'month')),
    j('MMMM', H('months'), E('months', 'month')),
    j('D', A, 'day'),
    j('DD', $, 'day'),
    j(['H', 'h'], A, 'hour'),
    j(['HH', 'hh'], $, 'hour'),
    ...
    j('d', P, 'weekday'),
    j('dd', H('weekdaysMin'), E('weekdaysMin', 'weekday')),
    j('ddd', H('weekdaysShort'), E('weekdaysShort', 'weekday')),
    j('dddd', H('weekdays'), E('weekdays', 'weekday')),
    j('w', A, 'week'),
    j('ww', $, 'week');
  var ee,
    te = (function(e, t) {
